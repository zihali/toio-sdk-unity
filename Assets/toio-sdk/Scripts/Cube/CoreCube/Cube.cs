...
namespace toio
{
    ...
    public abstract class Cube
    {
        ...
        /// </summary>
        /// <param name="left">左电机速度</param>
        /// <param name="right">右电机速度</param>
        /// <param name="durationMs">持续时间（毫秒）</param>
        /// <param name="order">命令优先级</param>
        ...
        /// </summary>
        /// <param name="red">红色强度</param>
        /// <param name="green">绿色强度</param>
        /// <param name="blue">蓝色强度</param>
        /// <param name="durationMs">持续时间（毫秒）</param>
        /// <param name="order">命令优先级</param>
        ...
        /// </summary>
        /// <param name="targetX">目标位置的X坐标值</param>
        /// <param name="targetY">目标位置的Y坐标值</param>
        /// <param name="targetAngle">目标位置处立方体的角度Θ</param>
        /// <param name="configID">控制识别值</param>
        /// <param name="timeOut">超时时间（秒）</param>
        /// <param name="targetMoveType">移动类型</param>
        /// <param name="maxSpd">电机的最大速度指示值</param>
        /// <param name="targetSpeedType">电机的速度变化类型</param>
        /// <param name="targetRotationType">旋转类型</param>
        /// <param name="order">命令的优先度</param>
        ...
        */
        ...
        /// <summary>
        /// 设置读取传感器的 Position ID 和 Standard ID 的通知频率。当同时满足 “最小通知间隔” 和 “通知条件” 时，将发送通知。
        /// https://toio.github.io/toio-spec/docs/ble_configuration#読み取りセンサーの - id - 通知設定
        /// </summary>
        /// <param name="intervalMs">最小通知间隔（毫秒），精度 10ms</param>
        /// <param name="notificationType">通知条件</param>
        /// <param name="timeOutSec">超时时间（秒）</param>
        /// <param name="callback">完成回调（设置成功标志，立方体）</param>
        /// <param name="order">命令优先级</param>
        ...
        /// <summary>
        /// 配置读取传感器的 Position ID 丢失和 Standard ID 丢失的通知灵敏度。
        /// https://toio.github.io/toio-spec/docs/ble_configuration#読み取りセンサーの - id-missed - 通知設定
        /// </summary>
        /// <param name="sensitivityMs">通知灵敏度（毫秒），精度 10ms</param>
        /// <param name="timeOutSec">超时时间（秒）</param>
        /// <param name="callback">完成回调（配置成功标志，立方体）</param>
        /// <param name="order">命令优先级</param>
