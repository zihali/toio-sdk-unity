...
public class DraggableItemMode1 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (targetDraggableItem != null && targetDraggableItem.tag == "Mode1Place")
        {
            ...
            if (name == "jia")
            {
                Mode1Control.Instance.AddCard(targetDraggableItem.transform, 1);
            }
            else if (name == "jian")
            {
                Mode1Control.Instance.AddCard(targetDraggableItem.transform, 2);
            }
            else if (name == "jia_star" )
            {
                Mode2Control.Instance.AddCard(targetDraggableItem.transform, 1);
            }
            else if (name == "jian_star" )
            {
                Mode2Control.Instance.AddCard(targetDraggableItem.transform, 2);
            }
        ...
        else if (targetDraggableItem != null && targetDraggableItem.CompareTag("Del") && name != "jian" && name != "jia" && name != "jian_star" && name != "jia_star")
        {
